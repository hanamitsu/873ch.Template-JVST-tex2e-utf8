...
%
% 公式のデータからいくつか書き換えてます。
%       https://vrsj.org/transaction/submission/
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% add package 
  ...
  \usepackage{here}     % figureの位置で[H]を使う時の
  \usepackage{url}      % URLの引用は個人的にこれを使ってる。\url{https://XXX.XXX.XXX/XXX/XX} 
  \usepackage{otf}
    % 暲(\UTF{66B2})や髙(\ajHashigoTaka、\UTF{9AD9})、﨑(\ajTatsuSaki、\UTF{FA11})などを使う時の特殊文字。
    % あると便利。
    % <参考>
    %   https://texwiki.texjp.org/?ptexenc
    %   https://qiita.com/penguin-lab/items/da8181b634496dfb8e62
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%採択受付日を記入してください。
%投稿時および日付がわからない場合にはコメントアウトしておいてください。
\saitaku{2023年XX月XX日}
